        ...
        for(let i = 0; i<Data.length;i++){
            ...
            <div id="resultno${i}" class="single-result row align-items-center my-3 p-3">
                <div class="col-md-9 mb-2">
                    ...
                    <p class="author lead h3">From <span class="" font-weight-bold">${albumName}<br>by <a class="lyrics-name text-warning font-weight-bold" herf="${artistLink}">${artistName}</a></span></p>
                </div>
            ...
            <div class="col-12 py-3">
                <div class="col-5 mx-auto text-center">
                    <a href="${songLink}" class="text-white font-weight-bold h4" target="_blank">Listen Now</a>
            ...
            <div class="col-12">
                <a href="${fullAlbum}" class="text-white font-weight-bold h4" target="_blank">Full Album</a>
            </div>`;
